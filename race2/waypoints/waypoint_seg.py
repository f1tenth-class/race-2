...
segment_points = [
    ...
    [-3.9, -0.5, 1.1, 3.0, 0.2, 0.01],
    [0.0, -0.5, 0.7, 1.5, 0.25, 0.05],
    [2.6, 0.45, 0.7, 1.5, 0.3, 0.02], # ADDING
    [3.9, 2.0, 1.0, 1.5, 0.4, 0.05], # haripin 1
    [4.1, 4.0, 0.9, 1.5, 0.5, 0.1],
    [2.6, 4.8, 1.0, 1.0, 0.3, 0.05], # 6
    [1.2, 3.8, 1.0, 1.0, 0.3, 0.01], # 7
    [0.3, 2.6, 1.0, 1.5, 0.1, 0.01], # 8
    [-2.2, 2.3, 0.8, 1.0, 0.1, 0.01], # 9
    [-4.7, 2.5, 0.7, 1.5, 0.35, 0.01], # hairpin 2 # 10
