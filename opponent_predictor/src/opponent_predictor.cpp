...
OpponentPredictor::OpponentPredictor() : Node("opponent_predictor_node") {
    // ROS Params
    this->declare_parameter("debug_img", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("visualize", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("visualize_grid", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("visualize_obstacle", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("visualize_opp", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("visualize_opp_pose", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("visualize_opp_bbox", rclcpp::PARAMETER_BOOL);

    this->declare_parameter("real_test", rclcpp::PARAMETER_BOOL);
    this->declare_parameter("map_name", rclcpp::PARAMETER_STRING);
    this->declare_parameter("map_img_ext", rclcpp::PARAMETER_STRING);
    this->declare_parameter("resolution", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("origin", rclcpp::PARAMETER_DOUBLE_ARRAY);

    this->declare_parameter("track_file", rclcpp::PARAMETER_STRING);
    this->declare_parameter("inner_bound", rclcpp::PARAMETER_STRING);
    this->declare_parameter("outer_bound", rclcpp::PARAMETER_STRING);
    this->declare_parameter("grid_xmin", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("grid_xmax", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("grid_ymin", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("grid_ymax", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("grid_resolution", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("plot_resolution", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("grid_safe_dist", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("goal_safe_dist", rclcpp::PARAMETER_DOUBLE);
    
    this->declare_parameter("cluster_dist_tol", rclcpp::PARAMETER_DOUBLE);
    this->declare_parameter("cluster_size_tol", rclcpp::PARAMETER_INTEGER);
    this->declare_parameter("avoid_dist", rclcpp::PARAMETER_DOUBLE);
    ...
    inner_bound_path = "/home/empaul/ese6150/race2_ws/opponent_predictor/outputs/" + map_name + "/" + inner_bound_path + ".csv";
    inner_bound = read_bound(inner_bound_path);

    string outer_bound_path = this->get_parameter("outer_bound").as_string();
    outer_bound_path = "/home/empaul/ese6150/race2_ws/opponent_predictor/outputs/" + map_name + "/" + outer_bound_path + ".csv";
...
void OpponentPredictor::read_map(const string &map_name, const string &map_img_ext) {
    string map_img_path = "/home/empaul/ese6150/race2_ws/opponent_predictor/map/" + map_name + map_img_ext;
