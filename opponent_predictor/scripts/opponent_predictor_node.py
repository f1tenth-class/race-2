...
class OpponentPredictor(Node):
    ...
    def __init__(self):
        ...
        # ROS Params
        self.declare_parameter("debug_img", rclpy.Parameter.Type.BOOL, False)
        self.declare_parameter("visualize", rclpy.Parameter.Type.BOOL, True)
        self.declare_parameter("visualize_grid", rclpy.Parameter.Type.BOOL, True)
        self.declare_parameter("visualize_obstacle", rclpy.Parameter.Type.BOOL, True)
        # self.declare_parameter("visualize_opp", rclpy.Parameter.Type.BOOL)
        self.declare_parameter("visualize_opp_pose", rclpy.Parameter.Type.BOOL, True)
        self.declare_parameter("visualize_opp_bbox", rclpy.Parameter.Type.BOOL, True)

        self.declare_parameter("real_test", rclpy.Parameter.Type.BOOL, False)
        ...
        self.declare_parameter("inner_bound", rclpy.Parameter.Type.STRING)
        self.declare_parameter("outer_bound", rclpy.Parameter.Type.STRING)

        self.declare_parameter("grid_xmin", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("grid_xmax", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("grid_ymin", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("grid_ymax", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("grid_resolution", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("plot_resolution", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("grid_safe_dist", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("goal_safe_dist", rclpy.Parameter.Type.DOUBLE)

        self.declare_parameter("cluster_dist_tol", rclpy.Parameter.Type.DOUBLE)
        self.declare_parameter("cluster_size_tol", rclpy.Parameter.Type.INTEGER)
        self.declare_parameter("avoid_dist", rclpy.Parameter.Type.DOUBLE)
